// app/demandes/[id]/components/ActionButtons.tsx
      ...
      <div className="flex w-full items-center justify-end">
        <div className="hidden md:flex flex-wrap items-center gap-2">
          ...
          >
            ...
            {isPending
              ? "Sauvegarde..."
              : demande.status === PurchaseRequestStatus.BROUILLON
              ? "Sauvegarder brouillon"
              : hasValidationErrors()
              ? `Erreurs de validation (${getValidationErrorCount()})`
              : "Sauvegarder"}
          </Button>
        </div>
        <div className="md:hidden flex items-center gap-2">
          <Button variant="outline" onClick={onCancel} aria-label="Annuler" title="Annuler">
            <X className="h-4 w-4" />
          </Button>
          <Button
            onClick={onSave}
  ...
  return (
    <div className="flex w-full items-center justify-end gap-2">
      <div className="hidden md:flex flex-wrap items-center gap-2 justify-end">
        {/* Actions À VÉRIFIER - UNIQUEMENT VALIDEUR */}
        {demande.status === PurchaseRequestStatus.A_VERIFIER && currentUserRole === "VALIDEUR" && (
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    Êtes-vous sûr de vouloir approuver cette demande d&apos;achat ? Cette action ne peut pas être annulée.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
                  <AlertDialogCancel>Annuler</AlertDialogCancel>
                  <AlertDialogAction onClick={() => onStatusChange(PurchaseRequestStatus.VALIDEE)}>Confirmer l&apos;approbation</AlertDialogAction>
                </AlertDialogFooter>
              </AlertDialogContent>
            </AlertDialog>
            ...
            <AlertDialog open={showRejectDialog} onOpenChange={onShowRejectDialogChange}>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    Êtes-vous sûr de vouloir rejeter cette demande d&apos;achat ? Cette action ne peut pas être annulée. Si oui veuillez préciser la
                    raison du rejet.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <div className="py-4">
            ...
            <AlertDialog open={showMoreInfoDialog} onOpenChange={onShowMoreInfoDialogChange}>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    Êtes-vous sûr de vouloir demander plus d&apos;informations sur cette demande d&apos;achat ? Si oui veuillez préciser quelles
        ...
        {/* Bouton passer en Suivi Compta quand Validée - UNIQUEMENT DEMANDEUR */}
        {demande.status === PurchaseRequestStatus.VALIDEE && (
          <>
            <Button variant="outline" onClick={onExport}>
              <Download className="h-4 w-4 mr-2" />
        ...
        {demande.status === PurchaseRequestStatus.SUIVI_COMPTA && currentUserRole === "COMPTABLE" && (
        ...
        {demande.status === PurchaseRequestStatus.EXPORTEE && currentUserRole === "COMPTABLE" && (
        ...
        {/* Bouton Soumettre - BROUILLON et A_MODIFIER */}
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    Êtes-vous sûr de vouloir soumettre cette demande d&apos;achat pour validation ? Cette action ne peut pas être annulée.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
                  <AlertDialogCancel>Annuler</AlertDialogCancel>
          ...
          <DropdownMenuContent align="end">
            {demande.status === PurchaseRequestStatus.A_VERIFIER && currentUserRole === "VALIDEUR" && (
              <>
                <DropdownMenuItem
                  onSelect={() => {
                    onStatusChange(PurchaseRequestStatus.VALIDEE);
                  }}
                >
                ...
                <DropdownMenuItem
                  onSelect={() => {
                    onShowMoreInfoDialogChange(true);
                  }}
                >
                  <span className="flex items-center gap-2">
            ...
            {demande.status === PurchaseRequestStatus.VALIDEE && (
              <>
                ...
                {currentUserRole === "DEMANDEUR" && (
                  <DropdownMenuItem
                    onSelect={() => {
                      onStatusChange(PurchaseRequestStatus.SUIVI_COMPTA);
                    }}
                  >
                    <span className="flex items-center gap-2">
                      <Clock className="h-4 w-4" />
            ...
            {demande.status === PurchaseRequestStatus.SUIVI_COMPTA && currentUserRole === "COMPTABLE" && (
              <DropdownMenuItem
                onSelect={() => {
                  onStatusChange(PurchaseRequestStatus.EXPORTEE);
                }}
              >
                Marquer comme exportée
              </DropdownMenuItem>
